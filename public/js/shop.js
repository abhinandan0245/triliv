(function ($) {
  ...
  var rangeTwoPrice = function () {
    if ($("#price-value-range").length > 0) {
      priceSlider = document.getElementById("price-value-range"); // assign to global
      var skipValues = [
        document.getElementById("price-min-value"),
        document.getElementById("price-max-value"),
      ];

      var min = parseInt(priceSlider.getAttribute("data-min"), 10) || 0;
      var max = parseInt(priceSlider.getAttribute("data-max"), 10) || 500;
      ...
      priceSlider.noUiSlider.on("update", function (val, e) {
  ...
  var filterProducts = function () {
    ...
    // ✅ Safe fallback with check
    const minPrice = priceSlider.dataset.min
      ? parseInt(priceSlider.dataset.min, 10)
      : 0;

    const maxPrice = priceSlider.dataset.max
      ? parseInt(priceSlider.dataset.max, 10)
      : 500;
