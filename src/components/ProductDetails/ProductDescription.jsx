    ...
    <section className="flat-spacing pt-0">
      <div className="container">
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div 
            className={`accordion-title ${activeAccordion === 'description' ? '' : 'collapsed'}`}
          ...
          <div 
            id="description" 
            className={`collapse ${activeAccordion === 'description' ? 'show' : ''}`}
          >
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div 
            className={`accordion-title ${activeAccordion === 'material' ? '' : 'collapsed'}`}
          ...
          <div 
            id="material" 
            className={`collapse ${activeAccordion === 'material' ? 'show' : ''}`}
          >
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div 
            className={`accordion-title ${activeAccordion === 'returnPolicies' ? '' : 'collapsed'}`}
            onClick={() => toggleAccordion('returnPolicies')}
            aria-expanded={activeAccordion === 'returnPolicies'}
          ...
          <div 
            id="returnPolicies" 
            className={`collapse ${activeAccordion === 'returnPolicies' ? 'show' : ''}`}
          >
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div 
            className={`accordion-title ${activeAccordion === 'addInformation' ? '' : 'collapsed'}`}
          ...
          <div 
            id="addInformation" 
            className={`collapse ${activeAccordion === 'addInformation' ? 'show' : ''}`}
          >
            <div className="accordion-body">
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div 
            className={`accordion-title ${activeAccordion === 'reviews' ? '' : 'collapsed'}`}
          ...
          <div 
            id="reviews" 
            className={`collapse ${activeAccordion === 'reviews' ? 'show' : ''}`}
          >
                ...
                <div className="box-rate-review">
                  <div className="rating-summary">
                    <ul className="list-star">
                      <li><i className="icon icon-star" /></li>
                      <li><i className="icon icon-star" /></li>
                      <li><i className="icon icon-star" /></li>
                      <li><i className="icon icon-star" /></li>
                      <li><i className="icon icon-star" /></li>
              ...
              <div className="review-section">
                <ul className="review-list">
                  <li className="review-item">
                    <div className="review-avt"><img src="images/blog-author-1.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      ...
                      <p className="text text-sm text-main-4">Absolutely stunning! I bought a gold
                        ...
                        definitely return for more!</p>
                    </div>
                  </li>
                  <li className="review-item">
                    <div className="review-avt"><img src="images/blog-author-2.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      <div className="review-info">
                        <div className="review-meta">
                  ...
                  <li className="review-item">
                    <div className="review-avt"><img src="images/blog-author-3.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      <div className="review-info">
                        <div className="review-meta">
                      ...
                      <p className="text text-sm text-main-4">This jewelry shop is my go-to! The
                        designs are elegant, and the prices are reasonable for the quality you
