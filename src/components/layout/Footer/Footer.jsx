                  ...
                  <div className="footer-contact">
                    <ul className="footer-info">
                      <li className="item">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps?q=123Yarranst,Punchbowl,NSW2196,Australia">
              ...
              <div className="footer-inner-wrap footer-col-block s2">
                ...
                <div className="tf-collapse-content">
                  <div className="footer-newsletter">
                    ...
                    <form onSubmit={handleSubscribe} className="form-newsletter" id="subscribe-form" method="post" acceptCharset="utf-8" data-mailchimp="true">
                      <div id="subscribe-content" className="subscribe-content">
                        <fieldset className="email">
                          <input type="email" name="email-form" id="subscribe-email" className="subscribe-email" placeholder="Email address" tabIndex="0" aria-required="true" required />
                        </fieldset>
                        <div className="button-submit">
                          <button id="subscribe-button" className="subscribe-button animate-btn" type="submit">
