...
import img1 from "../../assets/images/women-black-1.jpg"
import img2 from "../../assets/images/women-black-2.jpg"
import img3 from "../../assets/images/women-black-3.jpg"
import img4 from "../../assets/images/women-black-4.jpg"
import img5 from "../../assets/images/fs-orange1.jpg"
import img6 from "../../assets/images/fs-orange2.jpg"
                  ...
                  <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide" data-color="black" data-size="small">
                        <a href={img1} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img1} data-src={img1} src={img1} alt="img-product" />
                        </a>
                      </div>
                      <div className="swiper-slide" data-color="black" data-size="medium">
                        <a href={img2} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img2} data-src={img2} src={img2} alt="img-product" />
                        </a>
                      </div>
                      <div className="swiper-slide" data-color="black" data-size="large">
                        <a href={img3} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img3} data-src={img3} src={img3} alt="img-product" />
                        </a>
                      </div>
                      <div className="swiper-slide" data-color="black" data-size="extra large">
                        <a href={img4} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img4} data-src={img4} src={img4} alt="img-product" />
                        </a>
                      </div>
                      {/* yellow */}
                      <div className="swiper-slide" data-color="orange" data-size="small">
                        <a href={img5} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img5} data-src={img5} src={img5} alt="img-product" />
                        </a>
                      </div>
                      <div className="swiper-slide" data-color="orange" data-size="medium">
                        <a href={img6} target="_blank" className="item" data-pswp-width="552px" data-pswp-height="827px">
                          <img className="tf-image-zoom lazyload" data-zoom={img6} data-src={img6} src={img6} alt="img-product" />
                        </a>
                      </div>
                      {/* grey */}
                ...
                <div className="tf-product-heading">
                  ...
                  <div className="product-progress-sale">
                    ...
                    <div className="progress-sold">
                      <div className="value" style={{width: '0%'}} data-progress={70} />
                    </div>
                  </div>
                </div>
                <div className="tf-product-variant">
                  <div className="variant-picker-item variant-color">
                    <div className="variant-picker-label">
                      Colors:<span className="variant-picker-label-value value-currentColor">Black</span>
                    </div>
                    <div className="variant-picker-values">
                      <div className="hover-tooltip tooltip-bot color-btn active" data-color="black">
                  ...
                  <div className="variant-picker-item variant-size">
                    <div className="variant-picker-label">
                      <div>Size:<span className="variant-picker-label-value value-currentSize">Small</span>
                      </div>
              ...
              <div className="tf-product-fbt">
                ...
                <form className="tf-product-form-bundle">
                  <div className="tf-bundle-products">
                    <div className="tf-bundle-product-item item-has-checkbox check">
                      <div className="bundle-check">
                        <input type="checkbox" defaultChecked="checked" className="tf-check" />
                      </div>
                      <a href="product-detail.php" className="bundle-image">
                        <img src={img1} alt="img-product" />
                      </a>
                      <div className="bundle-info">
                        <div className="bundle-title text-sm fw-medium">This item: Single
                          Breasted Blazer</div>
                    ...
                    <div className="tf-bundle-product-item item-has-checkbox">
                      <div className="bundle-check">
                    ...
                    <div className="tf-bundle-product-item item-has-checkbox">
                      ...
                      <div className="bundle-info">
                        <div className="bundle-title text-sm fw-medium">One Shoulder Velvet
                          T-Shirt</div>
                        <div className="bundle-price text-md fw-medium">
                  ...
                  <div className="bundle-total-submit">
                    ...
                    <span className="total-price">$60.00</span>
                    <span className="total-price-old">$80.00</span>
                  </div>
                  <button data-bs-target="#shoppingCart" type="button" data-bs-toggle="offcanvas" className="btn-submit-total tf-btn btn-out-line-primary">Add selected to
                    cart</button>
                </form>
              </div>
            </div>
