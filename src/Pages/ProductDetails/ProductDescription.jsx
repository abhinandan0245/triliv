    ...
    <section className="flat-spacing pt-0">
      <div className="container">
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div
            className={`accordion-title ${
              activeAccordion === "returnPolicies" ? "" : "collapsed"
            }`}
          ...
          <div
            id="returnPolicies"
            className={`collapse ${
              activeAccordion === "returnPolicies" ? "show" : ""
            }`}
          >
        ...
        <div className="widget-accordion wd-product-descriptions">
          <div
            className={`accordion-title ${
              activeAccordion === "reviews" ? "" : "collapsed"
            }`}
                ...
                <ul className="review-list">
                  <li className="review-item">
                    <div className="review-avt">
                      <img src="images/blog-author-1.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      ...
                      <p className="text text-sm text-main-4">
                        Absolutely stunning! I bought a gold necklace from here,
                        and the quality exceeded my expectations. The
                  ...
                  <li className="review-item">
                    <div className="review-avt">
                      <img src="images/blog-author-2.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      <div className="review-info">
                        <div className="review-meta">
                      ...
                      <p className="text text-sm text-main-4">
                        I purchased an engagement ring, and my fiancée loves it!
                        The diamonds sparkle beautifully, and the staff was
                        incredibly helpful in guiding me through the selection
                  ...
                  <li className="review-item">
                    <div className="review-avt">
                      <img src="images/blog-author-3.jpg" alt="avt" />
                    </div>
                    <div className="review-content">
                      <div className="review-info">
                        <div className="review-meta">
                      ...
                      <p className="text text-sm text-main-4">
                        This jewelry shop is my go-to! The designs are elegant,
                        and the prices are reasonable for the quality you get. I
                        recently got a pair of silver earrings, and they are
                        just perfect. Amazing service too!
                      </p>
                    </div>
                  </li>
                </ul>
