        ...
        <div className="container">
          <div className="flat-title-2 d-xl-flex justify-content-xl-between">
            ...
            <div className="box-text">
              <p className="text-md">
                At <span className="fw-medium">Vineta</span>, we bring you thoughtfully curated collections that
                blend contemporary <br className="d-none d-xl-block" />
                designs with timeless elegance. With over 15 years of experience, we cater to <br className="d-none d-xl-block" />
                fashion enthusiasts who appreciate quality, style, and versatility.
              </p>
            </div>
          </div>
      ...
      <section className=" flat-spacing-3 pt-0">
        <div className="container">
          <div className="flat-title-2 d-xl-flex justify-content-xl-between">
            ...
            <div className="box-text">
              <p className="text-md">
                Our skilled stylists have thoughtfully assembled seasonal outfits that are both <br className="d-none d-xl-block" /> trendy and
                timeless. With a variety of looks, they're here to inspire your next <br className="d-none d-xl-block" /> fashion-forward
                ensemble.
              </p>
            </div>
          </div>
                ...
                <div className="tf-icon-box style-border">
                  ...
                  <div className="content">
                    ...
                    <p className="text-sm text-main text-line-clamp-4">
                      ...
                      collections offer superior comfort and lasting durability. Every piece is
              ...
              <SwiperSlide>
                <div className="tf-icon-box style-border">
                  ...
                  <div className="content">
                    ...
                    <p className="text-sm text-main text-line-clamp-4">
                      Our designs embrace simplicity at its finest. Vineta's understated yet
                      refined style captures the essence of modern fashion, making a statement.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide>
                <div className="tf-icon-box style-border">
                  ...
                  <div className="content">
                    ...
                    <p className="text-sm text-main text-line-clamp-4">
                      We celebrate individuality with a diverse range of sizes, offering clothing
                      that fits and flatters every body type. At Vineta, fashion is for everyone.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
        ...
        <div className="container">
          <div className="box-testimonial-quote text-center">
            ...
            <p className="text-xl lh-xl-32">
              "I've ordered from many places, but I have to say, this shop offers the best shipping <br className="d-none d-lg-block" /> experience
              ever. Thank you so much for the outstanding service!"
            </p>
            <div className="box-author">
              <div className="avt"><img src="images/tes-about.jpg" alt="Vineta Customer" /></div>
              <p className="text-md lh-xl-26 fw-medium">
                Vineta P
              </p>
            </div>
          </div>
