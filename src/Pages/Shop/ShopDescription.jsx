      ...
      <div id="description" className="flat-spacing pt-0">
        <div className="container">
          <p className="text text-md text-center">
            Our women's collection fuses classic sophistication with modern
            trends. From versatile daywear to statement pieces, each garment is
            crafted with high-quality fabrics and meticulous attention to detail
            for lasting comfort and a perfect fit.
          </p>
              ...
              <SwiperSlide>
                <div className="tf-icon-box style-2">
                  ...
                  <div className="content">
                    ...
                    <p className="desc text-grey-2">
                      We're here for you anytime with 24/7 customer support.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
