              ...
              <SwiperSlide>
                <div className="tf-icon-box style-2">
                  ...
                  <div className="content">
                    ...
                    <p className="desc text-grey-2">Enjoy free shipping on all orders over $150</p>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="tf-icon-box style-2">
                  ...
                  <div className="content">
                    ...
                    <p className="desc text-grey-2">Hassle-free returns for a worry-free shopping
                      experience.</p>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="tf-icon-box style-2">
                  ...
                  <div className="content">
                    ...
                    <p className="desc text-grey-2">We're here for you anytime with 24/7 customer support.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
