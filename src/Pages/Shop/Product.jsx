  ...
  const productsList = [
    {
      ...
      brand: "Vineta",
      description: "Product Specifications Care for fiber: 30% more recycled polyester. We label garments manufactured using environmentally friendly technologies and raw materials with the Join Life label.",
      colors: [
        { name: "Yellow", value: "bg-light-orange-2", img: "images/product/product-16.jpg" },
        { name: "Black", value: "bg-dark", img: "images/product/product-9.jpg" },
        { name: "Grey", value: "bg-grey-4", img: "images/product/product-7.jpg" }
      ],
      sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
      ...
      description: "Product Specifications Care for fiber: 30% more recycled polyester. We label garments manufactured using environmentally friendly technologies and raw materials with the Join Life label.",
      colors: [
        { name: "White", value: "bg-white", line: true, img: "images/product/product-17.jpg" },
        { name: "Dark Green", value: "bg-dark-green", img: "images/product/product-21.jpg" },
        { name: "Grey", value: "bg-grey-4", img: "images/product/product-19.jpg" }
      ],
      sizes: ["S", "M", "L", "XL"],
  ...
  const productsGrid = [
    {
      ...
      colors: [
        { name: "Grey", value: "bg-grey-4", img: "images/product/product-19.jpg" },
        { name: "Black", value: "bg-dark", img: "images/product/product-9.jpg" },
        { name: "White", value: "bg-white", line: true, img: "images/product/product-4.jpg" }
      ],
    ...
    // Product 3
{
  ...
  brand: "Vineta",
  colors: [
    { name: "Yellow", value: "bg-yellow", img: "images/product/product-3.jpg" },
    { name: "Grey", value: "bg-grey-4", img: "images/product/product-6.jpg" },
    { name: "White", value: "bg-white", line: true, img: "images/product/product-4.jpg" }
  ],
  sizes: ["S", "M", "L", "XL"],
...
// Product 4
{
  ...
  colors: [
    { name: "White", value: "bg-white", line: true, img: "images/product/product-17.jpg" },
    { name: "Light Orange", value: "bg-light-orange", img: "images/product/product-16.jpg" },
    { name: "Light Grey", value: "bg-grey-4", img: "images/product/product-5.jpg" }
  ],
  sizes: ["S", "M", "L"],
  mainImage: "images/product/product-17.jpg",
...
// Product 5
{
  ...
  brand: "Vineta",
  colors: [
    { name: "Beige", value: "bg-beige", img: "images/product/product-25.jpg" },
    { name: "Black", value: "bg-dark", img: "images/product/product-22.jpg" },
...
// Product 6
{
  ...
  brand: "Vineta",
  colors: [
    { name: "White", value: "bg-white", line: true, img: "images/product/product-6.jpg" },
    { name: "Dark Green", value: "bg-dark-green", img: "images/product/product-21.jpg" }
  ],
  sizes: ["XS", "S", "M", "L"],
...
// Product 7
{
  ...
  brand: "Zotac",
  colors: [
    { name: "Yellow", value: "bg-yellow-2", img: "images/women-yellow-2.jpg" },
    { name: "Light Orange", value: "bg-light-orange-2", img: "images/product/product-28.jpg" },
    { name: "Beige", value: "bg-beige", img: "images/product/product-7.jpg" }
  ],
  sizes: [],
...
// Product 8
{
  ...
  brand: "Zotac",
  colors: [
    { name: "White", value: "bg-white", line: true, img: "images/product/product-26.jpg" },
...
// Product 9
{
  ...
  brand: "Zotac",
  colors: [
    { name: "Light Purple", value: "bg-light-purple-3", img: "images/product/product-27.jpg" },
    { name: "Light Grey", value: "bg-grey-4", img: "images/product/product-11.jpg" },
    { name: "Light Orange", value: "bg-light-orange", img: "images/product/product-12.jpg" }
  ],
  sizes: ["M", "L", "XL"],
...
// Product 10
{
  ...
  brand: "Zotac",
  colors: [
    { name: "Light Blue", value: "bg-light-blue-2", img: "images/product/product-10.jpg" },
    { name: "Black", value: "bg-dark", img: "images/product/product-13.jpg" },
    { name: "Purple", value: "bg-light-purple", img: "images/product/product-14.jpg" }
  ],
  sizes: [],
...
// Product 11
{
  ...
  colors: [
    ...
    { name: "Light Purple", value: "bg-light-purple-3", img: "images/product/product-23.jpg" }
  ],
  sizes: [],
...
// Product 12
{
  ...
  colors: [
    { name: "Black", value: "bg-dark", img: "images/product/product-22.jpg" },
    { name: "Beige", value: "bg-beige", img: "images/product/product-5.jpg" },
    { name: "White", value: "bg-white", line: true, img: "images/product/product-1.jpg" }
  ],
  sizes: ["XS", "S", "M", "L", "XL", "2XL"],
...
// Product 13
{
  ...
  colors: [
    { name: "Black", value: "bg-dark", img: "images/product/product-13.jpg" },
    { name: "Light Purple", value: "bg-purple-3", img: "images/product/product-14.jpg" }
  ],
  sizes: ["L", "XL", "2XL"],
...
// Product 14
{
  ...
  brand: "Vineta",
  colors: [
    { name: "Black", value: "bg-dark", img: "images/product/product-20.jpg" },
    { name: "Light Orange", value: "bg-light-orange", img: "images/product/product-16.jpg" },
    { name: "White", value: "bg-white", line: true, img: "images/product/product-1.jpg" }
  ],
  sizes: ["XS", "S", "M", "L", "XL", "2XL"],
...
// Product 15
{
  ...
  colors: [
    { name: "Beige", value: "bg-beige", img: "images/product/product-7.jpg" },
    { name: "White", value: "bg-white", line: true, img: "images/product/product-11.jpg" },
    { name: "Light Orange", value: "bg-light-orange", img: "images/product/product-18.jpg" }
  ],
  sizes: ["S", "M", "L", "XL", "2XL"],
        ...
        <div className="tf-shop-control">
          <div className="tf-group-filter">
            <a href="#filterShop" data-bs-toggle="offcanvas" aria-controls="filterShop" className="tf-btn-filter">
              <span className="icon icon-filter" /><span className="text">Filter</span>
            </a>
            <div className="tf-dropdown-sort" data-bs-toggle="dropdown">
              ...
              <div className="dropdown-menu">
                <div 
                  className={`select-item ${sortValue === 'best-selling' ? 'active' : ''}`} 
                ...
                <div 
                  className={`select-item ${sortValue === 'a-z' ? 'active' : ''}`} 
                  data-sort-value="a-z"
                ...
                <div 
                  className={`select-item ${sortValue === 'z-a' ? 'active' : ''}`} 
                  data-sort-value="z-a"
                ...
                <div 
                  className={`select-item ${sortValue === 'price-low-high' ? 'active' : ''}`} 
                ...
                <div 
                  className={`select-item ${sortValue === 'price-high-low' ? 'active' : ''}`} 
          ...
          <ul className="tf-control-layout">
            ...
            <li 
              className={`tf-view-layout-switch sw-layout-2 ${layout === 'tf-col-2' ? 'active' : ''}`} 
            ...
            <li 
              className={`tf-view-layout-switch sw-layout-3 ${layout === 'tf-col-3' ? 'active' : ''}`} 
            ...
            <li 
              className={`tf-view-layout-switch sw-layout-4 ${layout === 'tf-col-4' ? 'active' : ''}`} 
        ...
        <div className="wrapper-control-shop">
          ...
          <div className="tf-list-layout wrapper-shop" id="listLayout" style={{display: layout === 'list' ? 'block' : 'none'}}>
            {productsList.map(product => (
              <div 
                key={product.id} 
                className={`card-product style-list ${product.availability === 'Out of stock' ? 'out-of-stock' : ''}`} 
              ...
              >
                <div className="card-product-wrapper">
                  ...
                  {product.discount && (
                    <div className="on-sale-wrap"><span className="on-sale-item">{product.discount}</span></div>
                  )}
                </div>
                    ...
                    {product.colors.length > 0 && (
                      <ul className="list-color-product">
                        {product.colors.map((color, index) => (
                          <li 
                            key={index} 
                            className={`list-color-item color-swatch hover-tooltip ${index === 0 ? 'active' : ''} ${color.line ? 'line' : ''}`}
                          >
                            <span className="tooltip color-filter">{color.name}</span>
                            <span className={`swatch-value ${color.value}`} />
                            <img className="lazyload" data-src={color.img} src={color.img} alt="image-product" />
                          </li>
                        ))}
                      </ul>
                    )}
                    {product.sizes.length > 0 && (
                      <ul className="size-box">
                        {product.sizes.map((size, index) => (
                          <li key={index} className="size-item text-xs">{size}</li>
                        ))}
                      </ul>
                    )}
                  </div>
                  <div className="list-product-btn">
                    <a href="#shoppingCart" data-bs-toggle="offcanvas" className="tf-btn btn-main-product add-to-cart animate-btn">
                      Add To cart
                    </a>
                    <a href="javascript:void(0);" className="box-icon wishlist hover-tooltip">
                    ...
                    <a href="#compare" data-bs-toggle="modal" aria-controls="compare" className="box-icon compare hover-tooltip">
          ...
          >
            {productsGrid.map(product => (
              <div 
                key={product.id} 
                className={`card-product grid style-1 ${product.sizes.length > 0 ? 'card-product-size' : ''} ${product.availability === 'Out of stock' ? 'out-of-stock' : ''}`} 
                data-availability={product.availability} 
                data-brand={product.brand}
              >
                <div className="card-product-wrapper">
                  ...
                  <ul className="list-product-btn">
                    <li>
                      <a href="#shoppingCart" data-bs-toggle="offcanvas" className="hover-tooltip tooltip-left box-icon">
                        <span className="icon icon-cart2" />
                        <span className="tooltip">Add to Cart</span>
                      </a>
                    </li>
                    <li className="wishlist">
                      <a href="javascript:void(0);" className="hover-tooltip tooltip-left box-icon">
                        <span className="icon icon-heart2" />
                        <span className="tooltip">Add to Wishlist</span>
                      </a>
                    </li>
