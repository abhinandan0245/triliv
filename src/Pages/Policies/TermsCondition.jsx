                ...
                <div className="container">
                    <div className="content">
                        <div className="term-item">
                            ...
                            <div className="text-wrap">
                                <p className="term-text body-text text-main">
                                    ...
                                    and some of the cookies that are installed on your device. Additionally, as you
                                    browse the Site, we collect information about the individual web pages or
                                    products that you view, what websites or search terms referred you to the
                                ...
                                <p className="term-text body-text text-main">
                                    ...
                                    cookies, and how to disable cookies, visit this link: <br />
                                    (.....) <br />
                                    ...
                                    Additionally, when you make a purchase or attempt to purchase through the
                                    Site, we collect certain information from you, including your name, billing
                                    address, shipping address, and payment information (including credit card
                                    number, email address, and phone number). We refer to this information as
                                    "Order Information".
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="term-item">
                            ...
                            <div className="text-wrap">
                                ...
                                <p className="term-text body-text text-main">
                                    ...
                                    or other lawful request for information we receive, or to otherwise protect
                                    our rights.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="term-item">
                            ...
                            <p className="term-text body-text text-main">
                                We may update this Terms & Condition from time to time to reflect, for example,
