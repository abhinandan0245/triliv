                    ...
                    <div className="main-content-account">
                        <div className="sidebar-account-wrap sidebar-content-wrap sticky-top d-lg-block d-none">
                            <ul className="my-account-nav">
                                ...
                                <li>
                                    <Link to="/account-orders" className="text-sm link fw-medium my-account-nav-item">My
                                        Orders</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link to="/account-detail"
                                        className="text-sm link fw-medium my-account-nav-item active">Account Details</Link>
                                </li>
                                <li>
